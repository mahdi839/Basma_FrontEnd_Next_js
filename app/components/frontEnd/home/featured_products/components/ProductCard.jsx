...
export default function ProductCard({slot_details,slotProducts,showOptionDiv,setShowOptionDiv,selectedSizes,handleSizeSelect,handleAddToCart,handleOptionDiv}) {
                ...
                <div className="position-relative overflow-hidden product-image-container"
                  ...
                  <Link href={`/frontEnd/product-page/${slotProducts?.id}`}>
                    <Image
                      width={500}
                      height={400}
                      src={slotProducts?.images?.[0]?.image ? baseUrl + slotProducts?.images[0]?.image : "/img/product/dress-1.png"}
